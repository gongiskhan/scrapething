...
public class APIDocsConfig {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo(
                "Contanst Gatherer 1.0 API",
                "REST webservice for gathering data from various sources and broadcast it through web-sockets.",
    ...
    private List<AuthorizationType> authorizationTypes() {
        ...
        LoginEndpoint loginEndpoint = new LoginEndpoint("http://localhost:8501/login");
        grantTypes.add(new ImplicitGrant(loginEndpoint, "access_token"));

        TokenRequestEndpoint tokenRequestEndpoint = new TokenRequestEndpoint("http://localhost:8501/login", "client_id", "client_secret");
        TokenEndpoint tokenEndpoint = new TokenEndpoint("http://localhost:8501/login", "auth_code");
