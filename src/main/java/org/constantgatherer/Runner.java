...
import org.constantgatherer.config.WebServerConfig;
import org.constantgatherer.config.WebServerContext;
...
//        SpotRepositoryRedisImpl spotRepositoryRedisImpl = WebServerContext.getApplicationContext().getBean(SpotRepositoryRedisImpl.class);
//        Gatherer spotConfig1 = Test.createMockSpotConfig();
//        spotRepository.saveSpotConfig(spotConfig1);

//        CrawlManager crawlManager = WebServerContext.getApplicationContext().getBean(CrawlManager.class);
//        crawlManager.startCrawlers(spotRepositoryRedisImpl.getAllSpotConfig());
